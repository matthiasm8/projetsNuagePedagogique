...
<nav class="navbar navbar-expand-lg sticky-top  bg-primary">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><img src="./assets/img/LOGO-GSB.png" alt="Bootstrap" width="90" height="50"></a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <li class="nav-item dropdown2">
          <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown2" aria-expanded="false">
            Visios
          </a>
          <ul class="dropdown-menu">
        ...
        <?php if($role=='Chef de produit'){echo '<li class="active"><a href="index.php?uc=cdp&action=voirproduit">Liste des Produits</a></li>
                                        <li class="active"><a href="index.php?uc=cdp&action=ajoutproduit">Ajouter un produit</a></li> ';}?>
